...
```
wget -N https://raw.githubusercontents.com/fengguowudi/XrayR-script/master/install.sh && bash install.sh
```
...
2. `git clone https://github.com/fengguowudi/XrayR-script XrayR-release`
3. `cd XrayR-release`
4. 编辑config。
